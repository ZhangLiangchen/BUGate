...
**仓库 release line：v0.4.5。** 详见
[release notes](docs/releases/v0.4.5.zh-CN.md)。版本文字本身不是发布证据；只有
GitHub Release 已实际列出以下三个资产时，v0.4.5 才具有正式分发权威：
...
把三个文件都附到 tag `v0.4.5` 的 GitHub Release。这些归档以一个版本化
