...
def _populate_self_healing_evidence(project: Path) -> None:
    """Seed opaque SUT-owned sidecar evidence for updater preservation checks."""
    ...
    opaque_receipt = (
        ...
        b'  "payload" : {"synthetic" : "opaque-update-evidence"},\n'
...
class ImportedUpdateIntegrationTests(unittest.TestCase):
    ...
    def _populate_sut_owned(self) -> tuple[str, ...]:
        ...
        _populate_self_healing_evidence(self.project)
        _write(
