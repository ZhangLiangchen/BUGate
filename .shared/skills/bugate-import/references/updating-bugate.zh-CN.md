...
3. archive/offline mode 下，从可信通道取得 release archive 与 `SHA256SUMS` asset，
   并放在 imported 仓之外。
4. 如果 managed/shared 文件依赖 ACL、extended attributes、ownership、hardlink
...
## 7. Profile migration 必须是独立 action 与 commit
...
acceptance、role receipt 或 `00_role_evidence/**`。
